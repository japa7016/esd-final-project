...
void ILI9341_PrintCentered(uint16_t x, uint16_t y, const char *str, uint16_t color, uint16_t bg);
void ILI9341_DrawGradient(uint16_t x, uint16_t y, uint16_t w, uint16_t h, uint16_t startColor, uint16_t endColor);
